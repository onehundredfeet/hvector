...
abstract Float3(Float3Data) to Float3Data from Float3Data {
	...
	public macro function copyIntoArray(self: haxe.macro.Expr.ExprOf<Float3>, array: haxe.macro.Expr.ExprOf<ArrayAccess<Float>>, index: haxe.macro.Expr.ExprOf<Int>) {
		return macro {
			var self = $self;
			var array = $array;
			var i: Int = $index;
